 ...
 * |---------------------------------------------------------------------------------------------------------------------------------------|
 * | ~ ` |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |  -  |  =  | Backspace | |Insrt|Home |PgUp | |NumLk|  /  |  *  |  -  |
 * |---------------------------------------------------------------------------------------------------------------------------------------|
 * |  Tab  |  Q  |  W  |  E  |  R  |  T  |  Y  |  U  |  I  |  O  |  P  |  [  |  ]  |         | | Del | End |PgDn | |  7  |  8  |  9  |  +  |
 * |--------------------------------------------------------------------------------'  Enter |---------------------------------------|     |
 * |  Caps  |  A  |  S  |  D  |  F  |  G  |  H  |  J  |  K  |  L  |  ;: |  '" |  \  |        |                     |  4  |  5  |  6  |     |
 * |---------------------------------------------------------------------------------------------------------------------------------------|
 * |Shift| Gui |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /? |    Shift        |       | Up  |       |  1  |  2  |  3  |Enter|
 * |-----------------------------------------------------------------------------------------|---------------------------------------|     |
...
*/
    ...
    KC_LCTL,            KC_LALT,                                KC_SPC,                                           KC_RALT,            KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT,            KC_P0,   LT(_WIN_FN,KC_PDOT)
    ),

    [_WIN_FN] = LAYOUT_iso102(
    _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,    
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,    _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,  _______,  _______,    _______,  _______,  _______,  KC_BRIU,
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,              _______,              KC_VOLD,  KC_MUTE,  KC_VOLU,  KC_BRID,
...
/*
    TODO
    - медиа клавиши на отдельном слое
        управление звуком 
            громче
            тише
            мут
